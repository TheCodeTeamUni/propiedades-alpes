...
from aeroalpes.modulos.vuelos.dominio.repositorios import RepositorioPropiedades, RepositorioProveedores
from aeroalpes.modulos.vuelos.dominio.objetos_valor import NombreAero, Odo, Leg, Segmento, Itinerario, CodigoIATA
from aeroalpes.modulos.vuelos.dominio.entidades import Proveedor, Aeropuerto, Propiedad
...
class RepositorioPropiedadesSQLite(RepositorioPropiedades):
    ...
    def agregar(self, reserva: Propiedad):
