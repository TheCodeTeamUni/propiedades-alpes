...
# Tabla intermedia para tener la relación de muchos a muchos entre la tabla propiedads e itinerarios
propiedads_itinerarios = db.Table(
    "propiedads_itinerarios",
    db.Model.metadata,
    db.Column("propiedad_id", db.String, db.ForeignKey("propiedads.id")),
...
class Reserva(db.Model):
    ...
    itinerarios = db.relationship('Itinerario', secondary=propiedads_itinerarios, backref='propiedads')
